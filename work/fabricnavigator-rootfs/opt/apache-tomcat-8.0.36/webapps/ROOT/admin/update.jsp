...
<link rel="stylesheet" href="/assets/app-shell.css?v=20260906-260">
...
<script defer src="/assets/app-shell.js?v=20260906-260">
</script>
</head>
<body>
<%if(flash.length()>0){%>
