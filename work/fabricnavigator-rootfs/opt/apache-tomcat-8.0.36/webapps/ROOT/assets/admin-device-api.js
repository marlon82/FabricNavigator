(function(){
  ...
  function init(){
    ...
    panel.className='fn-admin-tab-panel fn-admin-system-panel fn-device-api-panel';panel.dataset.adminCredentialPanel='device-api';panel.hidden=true;panel.innerHTML='<iframe class="fn-admin-system-frame" title="'+(de?'Geräte-API':'Device API')+'" data-src="/admin/device-api.jsp"></iframe>';content.appendChild(panel);
